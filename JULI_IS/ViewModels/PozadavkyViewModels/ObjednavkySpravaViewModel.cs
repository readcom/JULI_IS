...
{
	public class ObjednavkySpravaViewModel : AppViewModel
    {
        ...
        public override Task PreRender()
        {
            if (!Context.IsPostBack)
            {
                ...
                ItemsService.FillGridViewObjednavkyWithItemsFilteredNeschvalene(SeznamItemsGv, ColumnFilter, WhereFilter);
            ...
            if (SetDatum)
                ItemsService.FillGridViewObjednavkyWithItemsFilteredNeschvalene(SeznamItemsGv, "", "", DatumOd, DatumDo);
            else
                ItemsService.FillGridViewObjednavkyWithItemsFilteredNeschvalene(SeznamItemsGv, ColumnFilter, WhereFilter);
