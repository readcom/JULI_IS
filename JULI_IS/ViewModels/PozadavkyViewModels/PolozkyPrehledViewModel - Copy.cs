       ...
       public void SetSQL()
        ...
        public override Task PreRender()
        {
            if (!Context.IsPostBack)
            {
                ...
                ListKST = FilterService.GetKSTList();

                ListDodavatele = FilterService.PozadavkyGetDodavateleList();
                ListZalozil = FilterService.PozadavkyGetCreatorList();

                ListPozadavekFullId = FilterService.GetPozFullId();

                SeznamSloupcuI = FilterService.GetSeznamSloupcu("I");
                SeznamSloupcuP = FilterService.GetSeznamSloupcu("P");
